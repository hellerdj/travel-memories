...
if (isset($_GET['itemDetail'])) {
   ...
   foreach ($countryList as $index => $country){
    ...
    $content .= "<p class='lead'>This website is dedicated to the first time I traveled to Europe. My mission was to explore the various selections of local beers.</p>";
...
<html lang="en">
    ...
    <body>
    	<div class="jumbotron">
        	<div class="container">
            	<span class= "garamond"><h2 class="font-family-Garamond text-center">Reliving Memories, One Beer at a Time</h2></span>
            </div>
        </div>
            <div class="container">
            	<?=$content?>
